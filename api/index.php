...
<head>
    ...
    <meta name="description" content="Omnifood is a premium food delivery service witht he mission to bring affordable and healthy meals to as many people as possible.">
...
<body>
        ...
        <nav>
            <div class="row">
                ...
                <a class="mobile-nav-icon js--nav-icon">
                    <ion-icon name="menu-outline" class="js--icon-mobile"></ion-icon>
                </a>
                <a class="mobile-nav-icon js--nav-icon">
    ...
    <section class="section-cities" id="cities">
        ...
        <div class="row js--wp-3">
            ...
            <div class="col span-1-of-4 box">
                <img src="resources/img/berlin.png" alt="Berlin">
                <h3>Berlin</h3>
                <div class="city-feature">
                    <ion-icon name="person" class="icon-small"></ion-icon>
                    2300+ happy eaters
            ...
            <div class="col span-1-of-4 box">
                <img src="resources/img/london.png" alt="London">
                <h3>London</h3>
                <div class="city-feature">
                    <ion-icon name="person" class="icon-small"></ion-icon>
                    1200+ happy eaters
                ...
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            ...
                            <li>
                                <ion-icon name="close-outline" class="icon-small"></ion-icon>Access to newest creations
                            </li>
                            <li>
                                <ion-icon name="checkmark-outline" class="icon-small"></ion-icon>Free delivery
                            </li>
        ...
        <div class="row">
            ...
            <div class="col span-1-of-2">
                <ul class="social-links">
                    ...
                    <li><a href="#">
                            <ion-icon name="logo-google" class="googleplus"></ion-icon>
                        </a></li>
                    <li><a href="#">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-L858R4C7YZ"></script>
    <script>
